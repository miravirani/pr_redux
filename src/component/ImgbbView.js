...
//             {selectedFile && (
//                 <img src={selectedFile} className="urlimg" alt="Preview" />
//             )}

//             <h3>Auto delete image</h3>
//             <select name="upload-expiration" id="upload-expiration" className="text-input">
//                 <option value="" defaultValue>Don't autodelete</option>
//                 <option value="PT5M">After 5 minutes</option>
//                 <option value="PT15M">After 15 minutes</option>
//                 <option value="PT30M">After 30 minutes</option>
//                 <option value="PT1H">After 1 hour</option>
...
// export default connect(mapStateToProps, mapDispatchToProps)(ImgbbView);